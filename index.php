                    ...
                    <div class="flex-1 flex flex-col pt-8 pb-4 overflow-y-auto">
                        ...
                        <nav class="mt-2 flex-1 px-4 space-y-2">
                            ...
                            <div class="pt-6 pb-2 px-3">
                                <p class="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Coming Soon</p>
                            </div>
                            <button disabled class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border border-transparent text-slate-500 opacity-60 cursor-not-allowed">
                                <i data-lucide="mic" class="mr-3 h-5 w-5"></i> Mock Interview Mode
                            </button>
                            <button disabled class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border border-transparent text-slate-500 opacity-60 cursor-not-allowed">
                                <i data-lucide="pie-chart" class="mr-3 h-5 w-5"></i> Analytics Dashboard
                            </button>
                            <button disabled class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border border-transparent text-slate-500 opacity-60 cursor-not-allowed">
                                <i data-lucide="linkedin" class="mr-3 h-5 w-5"></i> LinkedIn Integration
                            </button>
                            <button disabled class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border border-transparent text-slate-500 opacity-60 cursor-not-allowed">
                                <i data-lucide="mouse-pointer-click" class="mr-3 h-5 w-5"></i> Auto-Fill Extension
                            </button>
                        </nav>
                    </div>
