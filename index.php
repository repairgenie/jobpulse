                    ...
                    <div class="flex-1 flex flex-col pt-8 pb-4 overflow-y-auto">
                        ...
                        <nav class="mt-2 flex-1 px-4 space-y-2">
                            ...
                            <button @click="currentView = 'analytics'; setTimeout(() => lucide.createIcons(), 50)" :class="currentView === 'analytics' ? 'bg-primary/10 text-primary border-primary/20' : 'text-slate-400 hover:text-white border-transparent hover:bg-slate-800'" class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border transition-all">
                                <i data-lucide="bar-chart-3" class="mr-3 h-5 w-5 opacity-100"></i> Analytics
                            </button>
...
<div x-show="currentView === 'auto_fill'" class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12" style="display:none;" x-cloak>
    <div class="mb-10">
        ...
        <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Configure your data for automatic job application population.</p>
    </div>
    <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
        <div class="p-3 bg-amber-500/20 rounded-xl shrink-0">
            <i data-lucide="construction" class="w-6 h-6 text-amber-500"></i>
        ...
        <div class="min-w-0">
            <h4 class="text-base font-bold text-amber-500 mb-1">Feature Under Construction</h4>
            <p class="text-sm text-slate-300 font-medium leading-relaxed">
                The <strong class="text-white">Auto-Fill</strong> feature is currently <strong class="text-amber-500">pending development</strong>.
                We are actively working to bring this capability to you soon.
            </p>
        </div>
    </div>
</div>
...
<div x-show="currentView === 'analytics'" class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12" style="display:none;" x-cloak>
    <div class="mb-10">
        ...
        <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Dive deep into your job search performance and success rates.</p>
    </div>
    <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
        <div class="p-3 bg-amber-500/20 rounded-xl shrink-0">
            <i data-lucide="construction" class="w-6 h-6 text-amber-500"></i>
        ...
        <div class="min-w-0">
            <h4 class="text-base font-bold text-amber-500 mb-1">Feature Under Construction</h4>
            <p class="text-sm text-slate-300 font-medium leading-relaxed">
                The <strong class="text-white">Analytics</strong> feature is currently <strong class="text-amber-500">pending development</strong>.
                Detailed insights and reporting will be available in a future update.
            </p>
        </div>
    </div>
</div>
...
<div x-show="currentView === 'linkedin'" class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12" style="display:none;" x-cloak>
    <div class="mb-10">
        ...
        <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Connect your LinkedIn profile for seamless data synchronization.</p>
    </div>
    <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
        <div class="p-3 bg-amber-500/20 rounded-xl shrink-0">
            <i data-lucide="construction" class="w-6 h-6 text-amber-500"></i>
        ...
        <div class="min-w-0">
            <h4 class="text-base font-bold text-amber-500 mb-1">Feature Under Construction</h4>
            <p class="text-sm text-slate-300 font-medium leading-relaxed">
                The <strong class="text-white">LinkedIn Integration</strong> feature is currently <strong class="text-amber-500">pending development</strong>.
                We are actively working on building this connection.
            </p>
        </div>
    </div>
</div>
