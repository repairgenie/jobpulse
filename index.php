...
<!-- Auto-Fill View -->
<div x-show="currentView === 'autofill'" x-transition.opacity.duration.300ms x-cloak class="relative z-10" x-init="$nextTick(() => lucide.createIcons())">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12">
        <div class="mb-8">
            <h1 class="text-3xl font-extrabold text-white tracking-tight">Auto-Fill</h1>
        ...
        <div class="bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
            ...
            <div class="min-w-0">
                ...
                <p class="text-sm text-slate-300 font-medium leading-relaxed">
                    This feature is part of our upcoming roadmap and is currently under active development.
                </p>
            </div>
        </div>
    </div>
...
<div x-show="currentView === 'analytics'" x-transition.opacity.duration.300ms x-cloak class="relative z-10" x-init="$nextTick(() => lucide.createIcons())">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12">
        <div class="mb-8">
            ...
            <p class="text-slate-400 mt-2 text-sm">Visualize your application conversion rate and identify which resume versions perform best.</p>
        </div>
        <div class="bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
            <div class="p-3 bg-amber-500/20 rounded-xl shrink-0">
                <i data-lucide="construction" class="w-6 h-6 text-amber-500"></i>
...
<div x-show="currentView === 'linkedin'" x-transition.opacity.duration.300ms x-cloak class="relative z-10" x-init="$nextTick(() => lucide.createIcons())">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12">
        <div class="mb-8">
