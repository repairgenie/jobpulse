                    ...
                    <div class="flex-1 flex flex-col pt-8 pb-4 overflow-y-auto">
                        ...
                        <nav class="mt-2 flex-1 px-4 space-y-2">
                            ...
                            <div class="mt-4 pt-4 border-t border-slate-700/50">
                                <p class="px-4 text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mb-2">Coming Soon</p>
                                <button class="w-full group flex items-center px-4 py-2 text-xs font-bold rounded-xl text-slate-500 cursor-not-allowed">
                                ...
                                <button class="w-full group flex items-center px-4 py-2 text-xs font-bold rounded-xl text-slate-500 cursor-not-allowed">
                                    <i data-lucide="chrome" class="mr-3 h-4 w-4 opacity-50"></i> Auto-Fill Extension
                                </button>
                            </div>
                        </nav>
                    </div>
