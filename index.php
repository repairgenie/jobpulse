...
<!-- Ask AI Chat Modal -->
            ...
            <div x-show="currentView === 'analytics'" class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12" style="display:none;" x-cloak>
                <div class="mb-10">
                    <h1 class="text-3xl md:text-5xl font-extrabold text-white mb-3 tracking-tight drop-shadow-md">Match Analytics</h1>
                    <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Advanced analytics and performance tracking.</p>
                </div>
                <div class="bg-card/80 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-8 shadow-xl flex items-center justify-center">
                    <div class="text-center">
                        <i data-lucide="clock" class="h-12 w-12 text-slate-500 mx-auto mb-4"></i>
                        <h3 class="text-xl font-bold text-white mb-2">Pending Development</h3>
                        <p class="text-slate-400">This feature is currently on our roadmap and will be available in a future update.</p>
                    </div>
                </div>
            </div>
