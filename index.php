                    ...
                    <div class="flex-1 flex flex-col pt-8 pb-4 overflow-y-auto">
                        ...
                        <nav class="mt-2 flex-1 px-4 space-y-2">
                            ...
                            <div class="pt-4 mt-4 border-t border-slate-700/50">
                                ...
                                <button disabled class="w-full group flex items-center px-4 py-2.5 text-sm font-bold text-slate-500/50 rounded-xl cursor-not-allowed">
                                    <i data-lucide="mic" class="mr-3 h-5 w-5 opacity-40"></i> Mock Interview Mode
                                </button>
                                <button disabled class="w-full group flex items-center px-4 py-2.5 text-sm font-bold text-slate-500/50 rounded-xl cursor-not-allowed">
                                    <i data-lucide="bar-chart-2" class="mr-3 h-5 w-5 opacity-40"></i> Advanced Analytics Dashboard
                                </button>
                                <button disabled class="w-full group flex items-center px-4 py-2.5 text-sm font-bold text-slate-500/50 rounded-xl cursor-not-allowed">
                                    <i data-lucide="linkedin" class="mr-3 h-5 w-5 opacity-40"></i> LinkedIn Integration
                                </button>
                                <button disabled class="w-full group flex items-center px-4 py-2.5 text-sm font-bold text-slate-500/50 rounded-xl cursor-not-allowed">
                                    <i data-lucide="form-input" class="mr-3 h-5 w-5 opacity-40"></i> Auto-Fill Extension
                                </button>
                            </div>
                        </nav>
                    </div>
