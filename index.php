                ...
                <div class="flex flex-col h-0 flex-1 bg-sidebar border-r border-slate-700/50 shadow-2xl">
                    <div class="flex-1 flex flex-col pt-8 pb-4 overflow-y-auto">
                        ...
                        <nav class="mt-2 flex-1 px-4 space-y-2">
                            ...
                            <!-- Coming Soon Section -->
                            <div class="pt-6 pb-2">
                                <h3 class="px-4 text-xs font-bold text-slate-500 uppercase tracking-widest mb-3">Coming Soon</h3>
                                <div class="space-y-2">
                                    <button class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border border-transparent text-slate-600 cursor-not-allowed opacity-60">
                                        <i data-lucide="mic" class="mr-3 h-5 w-5"></i> Mock Interview Mode
                                    </button>
                                    <button class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border border-transparent text-slate-600 cursor-not-allowed opacity-60">
                                        <i data-lucide="bar-chart-2" class="mr-3 h-5 w-5"></i> Advanced Analytics Dashboard
                                    </button>
                                    <button class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border border-transparent text-slate-600 cursor-not-allowed opacity-60">
