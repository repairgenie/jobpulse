...
<div x-show="currentView === 'auto_fill'" class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12" style="display:none;" x-cloak>
    <div class="mb-10">
        ...
        <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Use your saved resumes to automatically fill job application forms.</p>
    </div>
    ...
    <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
        ...
        <div class="min-w-0">
            ...
            <p class="text-sm text-slate-300 font-medium leading-relaxed">
                Please note that the <strong class="text-white">Auto-Fill</strong> feature is currently <strong class="text-amber-500">in development</strong>.
                We are working hard to integrate browser extension support for seamless form filling.
            </p>
        </div>
    </div>
</div>
...
<div x-show="currentView === 'analytics'" class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12" style="display:none;" x-cloak>
    <div class="mb-10">
        ...
        <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Visualize your application conversion rates and track resume performance.</p>
    </div>
    ...
    <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
        ...
        <div class="min-w-0">
            <h4 class="text-base font-bold text-amber-500 mb-1">Feature Under Construction</h4>
            <p class="text-sm text-slate-300 font-medium leading-relaxed">
                Please note that the <strong class="text-white">Analytics</strong> dashboard is currently <strong class="text-amber-500">in development</strong>.
                We are building powerful visual tools to help you analyze your application success metrics.
            </p>
        </div>
    </div>
</div>
...
<div x-show="currentView === 'linkedin'" class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12" style="display:none;" x-cloak>
    <div class="mb-10">
        ...
        <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Directly import job postings from LinkedIn via URL bookmarklet.</p>
    </div>
    ...
    <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
        ...
        <div class="min-w-0">
            <h4 class="text-base font-bold text-amber-500 mb-1">Feature Under Construction</h4>
            <p class="text-sm text-slate-300 font-medium leading-relaxed">
                Please note that the <strong class="text-white">LinkedIn Integration</strong> feature is currently <strong class="text-amber-500">in development</strong>.
                We are currently implementing the parsing logic to seamlessly import job details from LinkedIn URLs.
            </p>
        </div>
    </div>
</div>
