                    ...
                    <div class="flex-1 flex flex-col pt-8 pb-4 overflow-y-auto">
                        ...
                        <nav class="mt-2 flex-1 px-4 space-y-2">
                            ...
                            <div class="pt-4 mt-4 border-t border-slate-700/50">
                                <p class="px-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2">Coming Soon</p>
                                <button class="w-full group flex items-center px-4 py-2 text-sm font-bold text-slate-500 cursor-not-allowed rounded-xl border border-transparent transition-all">
                                    <i data-lucide="mic" class="mr-3 h-4 w-4 opacity-50"></i> Mock Interview Mode
                                </button>
                                <button class="w-full group flex items-center px-4 py-2 text-sm font-bold text-slate-500 cursor-not-allowed rounded-xl border border-transparent transition-all">
                                    <i data-lucide="form-input" class="mr-3 h-4 w-4 opacity-50"></i> Auto-Fill Extension
                                </button>
                                <button class="w-full group flex items-center px-4 py-2 text-sm font-bold text-slate-500 cursor-not-allowed rounded-xl border border-transparent transition-all">
                                    <i data-lucide="line-chart" class="mr-3 h-4 w-4 opacity-50"></i> Advanced Analytics
                                </button>
                                <button class="w-full group flex items-center px-4 py-2 text-sm font-bold text-slate-500 cursor-not-allowed rounded-xl border border-transparent transition-all">
