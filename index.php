                    ...
                    <div class="flex-1 flex flex-col pt-8 pb-4 overflow-y-auto">
                        ...
                        <nav class="mt-2 flex-1 px-4 space-y-2">
                            ...
                            <button @click="currentView = 'auto_fill'; setTimeout(() => lucide.createIcons(), 50)" :class="currentView === 'auto_fill' ? 'bg-primary/10 text-primary border-primary/20' : 'text-slate-400 hover:text-white border-transparent hover:bg-slate-800'" class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border transition-all">
                                <i data-lucide="pencil-ruler" class="mr-3 h-5 w-5 opacity-100"></i> Auto-Fill
                            </button>
                            ...
                            <button @click="currentView = 'linkedin_sync'; setTimeout(() => lucide.createIcons(), 50)" :class="currentView === 'linkedin_sync' ? 'bg-primary/10 text-primary border-primary/20' : 'text-slate-400 hover:text-white border-transparent hover:bg-slate-800'" class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border transition-all">
...
<!-- Auto-Fill View -->
<div x-show="currentView === 'auto_fill'" x-transition.opacity.duration.300ms x-cloak class="relative z-10" x-init="$nextTick(() => lucide.createIcons())">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12">
        <div class="mb-8">
            <h1 class="text-3xl font-extrabold text-white tracking-tight">Auto-Fill Integrations</h1>
            <p class="text-slate-400 mt-2 text-sm">Map your resume data to standard ATS form inputs.</p>
        </div>
        <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
            ...
            <div class="min-w-0">
                ...
                <p class="text-sm text-slate-300 font-medium leading-relaxed">
                    The <strong class="text-white">Auto-Fill</strong> feature is currently <strong class="text-amber-500">pending development</strong>. We are building a browser extension to allow you to inject optimized resume content directly into platforms like Workday and Greenhouse.
                </p>
            </div>
        </div>
    </div>
...
<!-- Analytics View -->
<div x-show="currentView === 'analytics'" x-transition.opacity.duration.300ms x-cloak class="relative z-10" x-init="$nextTick(() => lucide.createIcons())">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12">
        <div class="mb-8">
            <h1 class="text-3xl font-extrabold text-white tracking-tight">Analytics Dashboard</h1>
            <p class="text-slate-400 mt-2 text-sm">Track your application success rates and AI matching metrics.</p>
        </div>
        <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
            <div class="p-3 bg-amber-500/20 rounded-xl shrink-0">
                <i data-lucide="construction" class="w-6 h-6 text-amber-500"></i>
            ...
            <div class="min-w-0">
                <h4 class="text-base font-bold text-amber-500 mb-1">Feature Under Construction</h4>
                <p class="text-sm text-slate-300 font-medium leading-relaxed">
                    The <strong class="text-white">Analytics</strong> feature is currently <strong class="text-amber-500">pending development</strong>. We are working on visual dashboards to track interview conversion metrics and skills gap analysis.
                </p>
            </div>
        </div>
    </div>
...
<!-- LinkedIn Sync View -->
<div x-show="currentView === 'linkedin_sync'" x-transition.opacity.duration.300ms x-cloak class="relative z-10" x-init="$nextTick(() => lucide.createIcons())">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12">
        <div class="mb-8">
            <h1 class="text-3xl font-extrabold text-white tracking-tight">LinkedIn Sync</h1>
            <p class="text-slate-400 mt-2 text-sm">Automatically synchronize your AI-generated achievements with your LinkedIn profile.</p>
        </div>
        <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
            <div class="p-3 bg-amber-500/20 rounded-xl shrink-0">
                <i data-lucide="construction" class="w-6 h-6 text-amber-500"></i>
            ...
            <div class="min-w-0">
                <h4 class="text-base font-bold text-amber-500 mb-1">Feature Under Construction</h4>
                <p class="text-sm text-slate-300 font-medium leading-relaxed">
                    The <strong class="text-white">LinkedIn Sync</strong> feature is currently <strong class="text-amber-500">pending development</strong>. We are working on integrating the LinkedIn API to automate your profile updates.
                </p>
            </div>
        </div>
    </div>
