                ...
                <div class="flex flex-col h-0 flex-1 bg-sidebar border-r border-slate-700/50 shadow-2xl">
                    <div class="flex-1 flex flex-col pt-8 pb-4 overflow-y-auto">
                        ...
                        <nav class="mt-2 flex-1 px-4 space-y-2">
                            ...
                            <hr class="border-slate-700/50 mx-4 my-2" />

                            <button @click="currentView = 'analytics'; $nextTick(() => lucide.createIcons())" :class="currentView === 'analytics' ? 'bg-primary/10 text-primary border-primary/20' : 'text-slate-400 hover:text-white border-transparent hover:bg-slate-800'" class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border transition-all">
                                <i data-lucide="box" class="mr-3 h-5 w-5 opacity-100"></i> Analytics
                            </button>
                            <button @click="currentView = 'autofill'; $nextTick(() => lucide.createIcons())" :class="currentView === 'autofill' ? 'bg-primary/10 text-primary border-primary/20' : 'text-slate-400 hover:text-white border-transparent hover:bg-slate-800'" class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border transition-all">
                                <i data-lucide="box" class="mr-3 h-5 w-5 opacity-100"></i> Auto-Fill
                            </button>
                            <button @click="currentView = 'linkedin'; $nextTick(() => lucide.createIcons())" :class="currentView === 'linkedin' ? 'bg-primary/10 text-primary border-primary/20' : 'text-slate-400 hover:text-white border-transparent hover:bg-slate-800'" class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border transition-all">
