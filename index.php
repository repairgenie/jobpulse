...
<div x-show="currentView === 'mock_interview'" class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12" style="display:none;" x-cloak>
    <div class="mb-10">
        <h1 class="text-3xl md:text-5xl font-extrabold text-white mb-3 tracking-tight drop-shadow-md">Mock Interview Mode</h1>
        <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">A voice/text interface to practice answering the specific questions generated in the Tactical Analysis.</p>
    </div>

    <div class="mb-8 bg-card border border-slate-700/50 rounded-2xl p-8 flex flex-col items-center justify-center text-center shadow-xl">
        <div class="w-20 h-20 bg-darkcard/50 ring-1 ring-white/10 text-slate-500 rounded-full flex items-center justify-center mb-6 shadow-inner">
            <i data-lucide="mic" class="w-10 h-10"></i>
        </div>
        <h3 class="text-xl font-bold text-white mb-2">Select a Job Application to Start</h3>
        <p class="text-slate-400 text-sm max-w-md mb-8">Mock Interviews require context. Go to your <strong class="text-white">Pipeline</strong> or <strong class="text-white">My Jobs</strong> and click "Start Mock Interview Session" on a specific application.</p>

        <div class="flex space-x-4">
            <button @click="currentView = 'dashboard'; setTimeout(() => lucide.createIcons(), 50)" class="px-6 py-3 bg-slate-800 hover:bg-slate-700 text-white font-bold rounded-xl shadow-lg transition-all border border-slate-700">Go to Pipeline</button>
            <button @click="currentView = 'my_jobs'; setTimeout(() => lucide.createIcons(), 50)" class="px-6 py-3 bg-primary hover:bg-indigo-500 text-white font-bold rounded-xl shadow-lg transition-all">Go to My Jobs</button>
        </div>
    </div>
</div>
...
<div x-show="currentView === 'auto_fill'" class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12" style="display:none;" x-cloak>
    <div class="mb-10">
        <h1 class="text-3xl md:text-5xl font-extrabold text-white mb-3 tracking-tight drop-shadow-md">Auto-Fill Extension</h1>
    ...
    <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
        ...
        <div class="min-w-0">
            ...
            <p class="text-sm text-slate-300 font-medium leading-relaxed">
                This feature is on our roadmap and will be available soon.
            </p>
        </div>
    </div>
</div>
