                ...
                <div class="flex flex-col h-0 flex-1 bg-sidebar border-r border-slate-700/50 shadow-2xl">
                    <div class="flex-1 flex flex-col pt-8 pb-4 overflow-y-auto">
                        ...
                        <nav class="mt-2 flex-1 px-4 space-y-2">
                            ...
                            <button disabled class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border border-transparent text-slate-500 bg-slate-800/30 cursor-not-allowed">
                                <i data-lucide="mic" class="mr-3 h-5 w-5 opacity-50"></i> Mock Interview Mode
                            </button>
                            <button disabled class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border border-transparent text-slate-500 bg-slate-800/30 cursor-not-allowed">
                                <i data-lucide="bar-chart-2" class="mr-3 h-5 w-5 opacity-50"></i> Advanced Analytics
                            </button>
                            <button disabled class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border border-transparent text-slate-500 bg-slate-800/30 cursor-not-allowed">
                                <i data-lucide="linkedin" class="mr-3 h-5 w-5 opacity-50"></i> LinkedIn Import
                            </button>
                            <button disabled class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border border-transparent text-slate-500 bg-slate-800/30 cursor-not-allowed">
                                <i data-lucide="form-input" class="mr-3 h-5 w-5 opacity-50"></i> Auto-Fill Extension
                            </button>
                        </nav>
                    </div>
