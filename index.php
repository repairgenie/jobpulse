                ...
                <div class="flex flex-col h-0 flex-1 bg-sidebar border-r border-slate-700/50 shadow-2xl">
                    <div class="flex-1 flex flex-col pt-8 pb-4 overflow-y-auto">
                        ...
                        <nav class="mt-2 flex-1 px-4 space-y-2">
                            ...
                            <div class="pt-4 pb-2">
                                <p class="px-4 text-[10px] font-black tracking-widest text-slate-500 uppercase">Upcoming Features</p>
                            </div>
                            <button @click="currentView = 'analytics'; setTimeout(() => lucide.createIcons(), 50)" :class="currentView === 'analytics' ? 'bg-primary/10 text-primary border-primary/20' : 'text-slate-400 hover:text-white border-transparent hover:bg-slate-800'" class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border transition-all">
                                <i data-lucide="bar-chart" class="mr-3 h-5 w-5 opacity-100"></i> Advanced Analytics
                            </button>
...
<!-- Advanced Analytics View Placeholder -->
<div x-show="currentView === 'analytics'" class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12" style="display:none;" x-cloak>
    <div class="mb-10">
        ...
        <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Visualize your application conversion rates and identify top-performing resume variants.</p>
    </div>
    ...
    <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
        ...
        <div class="min-w-0">
            ...
            <p class="text-sm text-slate-300 font-medium leading-relaxed">
                The <strong class="text-white">Advanced Analytics</strong> feature is currently pending development. Stay tuned for visual charts and data insights on your applications.
            </p>
        </div>
    </div>
</div>
...
<div x-show="currentView === 'autofill'" class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12" style="display:none;" x-cloak>
    <div class="mb-10">
        ...
        <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Seamlessly populate job application forms directly from your browser.</p>
    </div>
    ...
    <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
        ...
        <div class="min-w-0">
            <h4 class="text-base font-bold text-amber-500 mb-1">Feature Under Construction</h4>
            <p class="text-sm text-slate-300 font-medium leading-relaxed">
                The <strong class="text-white">Auto-Fill Integration</strong> with browser extensions is on the roadmap but not yet active.
            </p>
        </div>
    </div>
</div>

<!-- LinkedIn Import View Placeholder -->
<div x-show="currentView === 'linkedin'" class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12" style="display:none;" x-cloak>
    <div class="mb-10">
        ...
        <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Directly import job descriptions and details from LinkedIn via URL.</p>
    </div>
    ...
    <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
        ...
        <div class="min-w-0">
            <h4 class="text-base font-bold text-amber-500 mb-1">Feature Under Construction</h4>
            <p class="text-sm text-slate-300 font-medium leading-relaxed">
                The <strong class="text-white">LinkedIn Import</strong> feature is actively being developed to streamline your application pipeline.
            </p>
        </div>
    </div>
</div>
