                    ...
                    <div class="flex-1 flex flex-col pt-8 pb-4 overflow-y-auto">
                        ...
                        <nav class="mt-2 flex-1 px-4 space-y-2">
                            ...
                            <button @click="currentView = 'analytics'; setTimeout(() => lucide.createIcons(), 50)" :class="currentView === 'analytics' ? 'bg-primary/10 text-primary border-primary/20' : 'text-slate-400 hover:text-white border-transparent hover:bg-slate-800'" class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border transition-all">
                                <i data-lucide="bar-chart" class="mr-3 h-5 w-5 opacity-100"></i> Analytics
                            </button>
                            <button @click="currentView = 'linkedin'; setTimeout(() => lucide.createIcons(), 50)" :class="currentView === 'linkedin' ? 'bg-primary/10 text-primary border-primary/20' : 'text-slate-400 hover:text-white border-transparent hover:bg-slate-800'" class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border transition-all">
                                <i data-lucide="link" class="mr-3 h-5 w-5 opacity-100"></i> LinkedIn Integration
                            </button>
...
<div x-show="currentView === 'auto_fill'" x-transition.opacity.duration.300ms x-cloak class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12">
    <div class="mb-10">
        ...
        <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Configure browser extension integration to automatically complete job application forms.</p>
    </div>
    ...
    <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
        ...
        <div class="min-w-0">
            ...
            <p class="text-sm text-slate-300 font-medium leading-relaxed">
                Please note that the <strong class="text-white">Auto-Fill</strong> feature is currently <strong class="text-amber-500">not fully implemented</strong>.
                We are working hard to integrate this capability.
            </p>
        </div>
    </div>
</div>
...
<div x-show="currentView === 'analytics'" x-transition.opacity.duration.300ms x-cloak class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12">
    <div class="mb-10">
        <h1 class="text-3xl md:text-5xl font-extrabold text-white mb-3 tracking-tight drop-shadow-md">Application Analytics</h1>
        <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">View detailed metrics and performance data for your job search.</p>
    </div>
    ...
    <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
        ...
        <div class="min-w-0">
            <h4 class="text-base font-bold text-amber-500 mb-1">Feature Under Construction</h4>
            <p class="text-sm text-slate-300 font-medium leading-relaxed">
                Please note that the <strong class="text-white">Analytics Dashboard</strong> feature is currently <strong class="text-amber-500">not fully implemented</strong>.
                We are working hard to integrate these visualizations.
            </p>
        </div>
    </div>
</div>
...
<div x-show="currentView === 'linkedin'" x-transition.opacity.duration.300ms x-cloak class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12">
    <div class="mb-10">
        ...
        <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Connect your profile to seamlessly import experience and sync job matches.</p>
    </div>
    ...
    <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
        ...
        <div class="min-w-0">
            <h4 class="text-base font-bold text-amber-500 mb-1">Feature Under Construction</h4>
            <p class="text-sm text-slate-300 font-medium leading-relaxed">
                Please note that the <strong class="text-white">LinkedIn Sync</strong> feature is currently <strong class="text-amber-500">not fully implemented</strong>.
                We are working hard to integrate the LinkedIn API.
            </p>
        </div>
    </div>
</div>
