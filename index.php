...
<!-- Ask AI Chat Modal -->
            ...
            <div x-show="currentView === 'autofill'" x-transition.opacity.duration.300ms x-cloak class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12">
                <div class="mb-10">
                    <h1 class="text-3xl md:text-5xl font-extrabold text-white mb-3 tracking-tight drop-shadow-md">Auto-Fill</h1>
                    <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Automatically fill out job applications across various platforms.</p>
                </div>
                <div class="bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
                    ...
                    <div class="min-w-0">
                        ...
                        <p class="text-sm text-slate-300 font-medium leading-relaxed">
                            The <strong class="text-white">Auto-Fill</strong> feature is currently <strong class="text-amber-500">pending development</strong>. Stay tuned for future updates!
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div x-show="currentView === 'analytics'" x-transition.opacity.duration.300ms x-cloak class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12">
                <div class="mb-10">
                    <h1 class="text-3xl md:text-5xl font-extrabold text-white mb-3 tracking-tight drop-shadow-md">Analytics</h1>
                    <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Dive deep into your job search performance and uncover insights.</p>
                </div>
                <div class="bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
                    <div class="p-3 bg-amber-500/20 rounded-xl shrink-0">
                        <i data-lucide="construction" class="w-6 h-6 text-amber-500"></i>
                    ...
                    <div class="min-w-0">
                        <h4 class="text-base font-bold text-amber-500 mb-1">Feature Under Construction</h4>
                        <p class="text-sm text-slate-300 font-medium leading-relaxed">
                            The <strong class="text-white">Analytics</strong> feature is currently <strong class="text-amber-500">pending development</strong>. Stay tuned for future updates!
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div x-show="currentView === 'linkedin'" x-transition.opacity.duration.300ms x-cloak class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12">
                <div class="mb-10">
                    <h1 class="text-3xl md:text-5xl font-extrabold text-white mb-3 tracking-tight drop-shadow-md">LinkedIn Integration</h1>
                    <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Sync your LinkedIn profile directly with your JobPulse AI account.</p>
                </div>
                <div class="bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
                    <div class="p-3 bg-amber-500/20 rounded-xl shrink-0">
                        <i data-lucide="construction" class="w-6 h-6 text-amber-500"></i>
                    ...
                    <div class="min-w-0">
                        <h4 class="text-base font-bold text-amber-500 mb-1">Feature Under Construction</h4>
                        <p class="text-sm text-slate-300 font-medium leading-relaxed">
                            The <strong class="text-white">LinkedIn Integration</strong> feature is currently <strong class="text-amber-500">pending development</strong>. Stay tuned for future updates!
                        </p>
                    </div>
                </div>
            </div>
