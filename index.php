...
<div x-show="currentView === 'auto_fill'" class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12" style="display:none;" x-cloak>
    <div class="mb-10">
        <h1 class="text-3xl md:text-5xl font-extrabold text-white mb-3 tracking-tight drop-shadow-md">Auto-Fill Application</h1>
        <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Automatically fill external job application forms with your optimized resume data.</p>
    </div>
...
<div x-show="currentView === 'analytics'" class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12" style="display:none;" x-cloak>
    <div class="mb-10">
        ...
        <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">View your application success rates, interview conversions, and career growth metrics.</p>
    </div>
    <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
        <div class="p-3 bg-amber-500/20 rounded-xl shrink-0">
            <i data-lucide="construction" class="w-6 h-6 text-amber-500"></i>
...
<div x-show="currentView === 'linkedin'" class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12" style="display:none;" x-cloak>
    <div class="mb-10">
        ...
        <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Sync your LinkedIn profile to automatically update your job history and resumes.</p>
    </div>
    <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
        <div class="p-3 bg-amber-500/20 rounded-xl shrink-0">
            <i data-lucide="construction" class="w-6 h-6 text-amber-500"></i>
