                    ...
                    <div class="flex-1 flex flex-col pt-8 pb-4 overflow-y-auto">
                        ...
                        <nav class="mt-2 flex-1 px-4 space-y-2">
                            ...
                            <div class="pt-4 pb-2 px-4">
                                <h3 class="text-[10px] font-extrabold text-slate-500 uppercase tracking-widest">Coming Soon</h3>
                            </div>
                            <div class="space-y-1">
                                <button disabled class="w-full group flex items-center px-4 py-2 text-sm font-medium rounded-xl border border-transparent text-slate-500 opacity-60 cursor-not-allowed">
                                ...
                                <button disabled class="w-full group flex items-center px-4 py-2 text-sm font-medium rounded-xl border border-transparent text-slate-500 opacity-60 cursor-not-allowed">
                                    <i data-lucide="link" class="mr-3 h-5 w-5"></i> LinkedIn Import
                                </button>
                                <button disabled class="w-full group flex items-center px-4 py-2 text-sm font-medium rounded-xl border border-transparent text-slate-500 opacity-60 cursor-not-allowed">
