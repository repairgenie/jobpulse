...
<div x-show="currentView === 'autofill'" x-transition.opacity.duration.300ms x-cloak class="relative z-10">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12">
        <div class="mb-10">
            <h1 class="text-3xl md:text-5xl font-extrabold text-white mb-3 tracking-tight drop-shadow-md">Auto-Fill Integration</h1>
            <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Browser extension integration to automatically fill job application forms using your saved resumes.</p>
        </div>
        ...
        <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
            ...
            <div class="min-w-0">
                ...
                <p class="text-sm text-slate-300 font-medium leading-relaxed">
                    ...
                    We are working hard to integrate this browser extension capability.
                </p>
            </div>
        </div>
    </div>
...
<div x-show="currentView === 'analytics'" x-transition.opacity.duration.300ms x-cloak class="relative z-10">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12">
        <div class="mb-10">
            ...
            <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Visualize your application conversion rates and identify top-performing resume versions.</p>
        </div>
        ...
        <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
            ...
            <div class="min-w-0">
                <h4 class="text-base font-bold text-amber-500 mb-1">Feature Under Construction</h4>
                <p class="text-sm text-slate-300 font-medium leading-relaxed">
                    Please note that the <strong class="text-white">Advanced Analytics Dashboard</strong> is currently <strong class="text-amber-500">not fully implemented</strong>.
                    We are working hard to bring you these insights.
                </p>
            </div>
        </div>
    </div>
...
<div x-show="currentView === 'linkedin'" x-transition.opacity.duration.300ms x-cloak class="relative z-10">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12">
        <div class="mb-10">
            ...
            <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Directly import job postings via our LinkedIn URL bookmarklet.</p>
        </div>
