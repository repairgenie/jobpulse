                    ...
                    <div class="flex-1 flex flex-col pt-8 pb-4 overflow-y-auto">
                        ...
                        <nav class="mt-2 flex-1 px-4 space-y-2">
                            ...
                            <div class="pt-4 mt-4 border-t border-slate-700/50">
                                <h3 class="px-4 text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Coming Soon</h3>

                                <button disabled class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border border-transparent text-slate-500 cursor-not-allowed transition-all opacity-60">
                                    <i data-lucide="mic" class="mr-3 h-5 w-5"></i> Mock Interview Mode
                                </button>
                                <button disabled class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border border-transparent text-slate-500 cursor-not-allowed transition-all opacity-60">
                                    <i data-lucide="pie-chart" class="mr-3 h-5 w-5"></i> Advanced Analytics
                                </button>
                                <button disabled class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border border-transparent text-slate-500 cursor-not-allowed transition-all opacity-60">
                                    <i data-lucide="linkedin" class="mr-3 h-5 w-5"></i> LinkedIn Import
                                </button>
                                <button disabled class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border border-transparent text-slate-500 cursor-not-allowed transition-all opacity-60">
                                    <i data-lucide="puzzle" class="mr-3 h-5 w-5"></i> Auto-Fill Extension
                                </button>
                            </div>
                        </nav>
                    </div>
