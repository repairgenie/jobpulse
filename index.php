                    ...
                    <div class="flex-1 flex flex-col pt-8 pb-4 overflow-y-auto">
                        ...
                        <nav class="mt-2 flex-1 px-4 space-y-2">
                            ...
                            <div class="mt-8 mb-2 px-4">
                                <p class="text-xs font-bold text-slate-500 uppercase tracking-widest mb-3">Coming Soon</p>
                            </div>
                            <button class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border border-transparent text-slate-500 cursor-not-allowed opacity-60">
                                <i data-lucide="mic" class="mr-3 h-5 w-5"></i> Mock Interview Mode
                            </button>
                            <button class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border border-transparent text-slate-500 cursor-not-allowed opacity-60">
                                <i data-lucide="bar-chart-3" class="mr-3 h-5 w-5"></i> Analytics Dashboard
                            </button>
                            <button class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border border-transparent text-slate-500 cursor-not-allowed opacity-60">
                                <i data-lucide="link" class="mr-3 h-5 w-5"></i> LinkedIn Integration
                            </button>
                            <button class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border border-transparent text-slate-500 cursor-not-allowed opacity-60">
                                <i data-lucide="box" class="mr-3 h-5 w-5"></i> Auto-Fill Extension
                            </button>
                        </nav>
                    </div>
