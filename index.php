                    ...
                    <div class="flex-1 flex flex-col pt-8 pb-4 overflow-y-auto">
                        ...
                        <nav class="mt-2 flex-1 px-4 space-y-2">
                            ...
                            <button @click="currentView = 'auto_fill'; setTimeout(() => lucide.createIcons(), 50)" :class="currentView === 'auto_fill' ? 'bg-primary/10 text-primary border-primary/20' : 'text-slate-400 hover:text-white border-transparent hover:bg-slate-800'" class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border transition-all">
                                <i data-lucide="pencil-line" class="mr-3 h-5 w-5 opacity-100"></i> Auto-Fill
                            </button>
...
<div x-show="currentView === 'auto_fill'" x-transition.opacity.duration.300ms x-cloak class="relative z-10">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12">
        <div class="mb-10">
            ...
            <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Use your saved resumes to automatically fill out job applications online.</p>
        </div>
        ...
        <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
            ...
            <div class="min-w-0">
                ...
                <p class="text-sm text-slate-300 font-medium leading-relaxed">
                    ...
                    We are working hard to integrate a browser extension to help auto-fill application forms using your saved resumes.
                </p>
            </div>
        </div>
    </div>
...
<div x-show="currentView === 'analytics'" x-transition.opacity.duration.300ms x-cloak class="relative z-10">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12">
        <div class="mb-10">
            ...
            <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Visualize your application conversion rate and identify top-performing resumes.</p>
        </div>
        ...
        <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
            ...
            <div class="min-w-0">
                ...
                <p class="text-sm text-slate-300 font-medium leading-relaxed">
                    ...
                    We are working hard to bring you comprehensive visualizations of your application conversion rates.
                </p>
            </div>
        </div>
    </div>
...
<div x-show="currentView === 'linkedin_integration'" x-transition.opacity.duration.300ms x-cloak class="relative z-10">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12">
        <div class="mb-10">
            ...
            <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Directly import job postings from LinkedIn via URL.</p>
        </div>
        ...
        <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
            ...
            <div class="min-w-0">
                ...
                <p class="text-sm text-slate-300 font-medium leading-relaxed">
                    ...
                    We are working hard to provide a seamless way to import job postings via URL bookmarklet.
                </p>
            </div>
        </div>
    </div>
