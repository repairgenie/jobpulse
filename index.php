...
<div x-show="currentView === 'analytics'" x-transition.opacity.duration.300ms x-cloak class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12">
    <div class="mb-10">
        <h1 class="text-3xl md:text-5xl font-extrabold text-white mb-3 tracking-tight drop-shadow-md">Advanced Analytics</h1>
        <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Visualize your application conversion rates and identify which resume versions perform best.</p>
    </div>
    ...
    <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
        ...
        <div class="min-w-0">
            ...
            <p class="text-sm text-slate-300 font-medium leading-relaxed">
                The <strong class="text-white">Advanced Analytics Dashboard</strong> is pending development. We are working hard to bring you comprehensive data visualization and actionable insights.
            </p>
        </div>
    </div>
</div>
...
<div x-show="currentView === 'autofill'" x-transition.opacity.duration.300ms x-cloak class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12">
    <div class="mb-10">
        <h1 class="text-3xl md:text-5xl font-extrabold text-white mb-3 tracking-tight drop-shadow-md">Auto-Fill Integration</h1>
        <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Browser extension integration to automatically fill job applications using your optimized profiles.</p>
    </div>
    ...
    <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
        ...
        <div class="min-w-0">
            <h4 class="text-base font-bold text-amber-500 mb-1">Feature Under Construction</h4>
            <p class="text-sm text-slate-300 font-medium leading-relaxed">
                The <strong class="text-white">Auto-Fill Integration</strong> feature is pending development. We are actively building the browser extension to streamline your application process.
            </p>
        </div>
    </div>
</div>

<!-- LinkedIn View Placeholder -->
<div x-show="currentView === 'linkedin'" x-transition.opacity.duration.300ms x-cloak class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12">
    <div class="mb-10">
        ...
        <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Directly import job postings and sync your professional network data.</p>
    </div>
    ...
    <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
        ...
        <div class="min-w-0">
            <h4 class="text-base font-bold text-amber-500 mb-1">Feature Under Construction</h4>
            <p class="text-sm text-slate-300 font-medium leading-relaxed">
                The <strong class="text-white">LinkedIn Integration</strong> is pending development. Support for seamless importing via URL bookmarklets is on our roadmap.
            </p>
        </div>
    </div>
</div>
