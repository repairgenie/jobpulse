...
<div x-show="currentView === 'auto_fill'" x-transition.opacity.duration.300ms x-cloak class="relative z-10">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12">
        <div class="mb-8">
            ...
            <p class="text-slate-400 mt-2 text-sm">Automatically populate applications.</p>
        </div>
        <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
            ...
            <div class="min-w-0">
                ...
                <p class="text-sm text-slate-300 font-medium leading-relaxed">
                    This feature is pending development and will be available in a future release.
                </p>
            </div>
        </div>
    </div>
...
<div x-show="currentView === 'analytics'" x-transition.opacity.duration.300ms x-cloak class="relative z-10">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12">
        <div class="mb-8">
            ...
            <p class="text-slate-400 mt-2 text-sm">View detailed insights on your applications.</p>
        </div>
        <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
            <div class="p-3 bg-amber-500/20 rounded-xl shrink-0">
                <i data-lucide="construction" class="w-6 h-6 text-amber-500"></i>
...
<div x-show="currentView === 'linkedin_integration'" x-transition.opacity.duration.300ms x-cloak class="relative z-10">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12">
        <div class="mb-8">
            ...
            <p class="text-slate-400 mt-2 text-sm">Sync your LinkedIn profile directly.</p>
        </div>
        <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
            <div class="p-3 bg-amber-500/20 rounded-xl shrink-0">
                <i data-lucide="construction" class="w-6 h-6 text-amber-500"></i>
