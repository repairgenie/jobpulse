...
<!-- Auto-Fill View -->
<div x-show="currentView === 'auto_fill'" x-transition.opacity.duration.300ms x-cloak class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12" style="display:none;">
    <div class="mb-10">
        <h1 class="text-3xl md:text-5xl font-extrabold text-white mb-3 tracking-tight drop-shadow-md">Auto-Fill</h1>
        <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Automatically fill job applications using your profile.</p>
    </div>
...
<!-- Analytics View -->
<div x-show="currentView === 'analytics'" x-transition.opacity.duration.300ms x-cloak class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12" style="display:none;">
    <div class="mb-10">
        <h1 class="text-3xl md:text-5xl font-extrabold text-white mb-3 tracking-tight drop-shadow-md">Analytics</h1>
        <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">View insights and metrics for your job applications.</p>
    </div>
    ...
    <div class="mb-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl p-6 flex items-start gap-4 shadow-xl">
        ...
        <div class="min-w-0">
            ...
            <p class="text-sm text-slate-300 font-medium leading-relaxed">
                ...
                We are working hard to build this dashboard.
            </p>
        </div>
    </div>
</div>
...
<div x-show="currentView === 'linkedin_integration'" x-transition.opacity.duration.300ms x-cloak class="max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12" style="display:none;">
    <div class="mb-10">
        <h1 class="text-3xl md:text-5xl font-extrabold text-white mb-3 tracking-tight drop-shadow-md">LinkedIn Integration</h1>
        <p class="text-slate-400 text-sm md:text-base font-medium max-w-2xl">Connect your LinkedIn profile for enhanced tracking and applying.</p>
    </div>
