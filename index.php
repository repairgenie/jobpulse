                    ...
                    <div class="flex-1 flex flex-col pt-8 pb-4 overflow-y-auto">
                        ...
                        <nav class="mt-2 flex-1 px-4 space-y-2">
                            ...
                            <div class="pt-4 mt-2 border-t border-slate-700/50">
                                <p class="px-4 text-xs font-black uppercase tracking-widest text-slate-500 mb-2">Coming Soon</p>
                                <button class="w-full group flex items-center px-4 py-2 text-sm font-bold rounded-xl border border-transparent text-slate-500 cursor-not-allowed">
                                    <i data-lucide="mic" class="mr-3 h-4 w-4 opacity-50"></i> Mock Interview
                                </button>
                                <button class="w-full group flex items-center px-4 py-2 text-sm font-bold rounded-xl border border-transparent text-slate-500 cursor-not-allowed">
                                    <i data-lucide="pie-chart" class="mr-3 h-4 w-4 opacity-50"></i> Analytics
                                </button>
                                <button class="w-full group flex items-center px-4 py-2 text-sm font-bold rounded-xl border border-transparent text-slate-500 cursor-not-allowed">
                                    <i data-lucide="linkedin" class="mr-3 h-4 w-4 opacity-50"></i> LinkedIn Import
                                </button>
                                <button class="w-full group flex items-center px-4 py-2 text-sm font-bold rounded-xl border border-transparent text-slate-500 cursor-not-allowed">
                                    <i data-lucide="chrome" class="mr-3 h-4 w-4 opacity-50"></i> Auto-Fill Ext
                                </button>
                            </div>
                        </nav>
                    </div>
