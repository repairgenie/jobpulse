                    ...
                    <div class="flex-1 flex flex-col pt-8 pb-4 overflow-y-auto">
                        ...
                        <nav class="mt-2 flex-1 px-4 space-y-2">
                            ...
                            <div class="pt-4 mt-4 border-t border-slate-700/50">
                                ...
                                <button class="w-full group flex items-center px-4 py-2 text-sm font-bold rounded-xl border border-transparent text-slate-500 cursor-not-allowed opacity-50" disabled>
                                    <i data-lucide="mic" class="mr-3 h-4 w-4"></i> Mock Interview
                                </button>
                                <button class="w-full group flex items-center px-4 py-2 text-sm font-bold rounded-xl border border-transparent text-slate-500 cursor-not-allowed opacity-50" disabled>
                                    <i data-lucide="bar-chart" class="mr-3 h-4 w-4"></i> Analytics
                                </button>
                                <button class="w-full group flex items-center px-4 py-2 text-sm font-bold rounded-xl border border-transparent text-slate-500 cursor-not-allowed opacity-50" disabled>
                                    <i data-lucide="linkedin" class="mr-3 h-4 w-4"></i> LinkedIn Import
                                </button>
                                <button class="w-full group flex items-center px-4 py-2 text-sm font-bold rounded-xl border border-transparent text-slate-500 cursor-not-allowed opacity-50" disabled>
                                    <i data-lucide="form-input" class="mr-3 h-4 w-4"></i> Auto-Fill Ext
                                </button>
                            </div>
                        </nav>
                    </div>
