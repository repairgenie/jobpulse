                ...
                <div class="flex flex-col h-0 flex-1 bg-sidebar border-r border-slate-700/50 shadow-2xl">
                    <div class="flex-1 flex flex-col pt-8 pb-4 overflow-y-auto">
                        ...
                        <nav class="mt-2 flex-1 px-4 space-y-2">
                            ...
                            <button @click="showToast('Mock Interview Mode is coming soon!', 'info')" class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border border-transparent text-slate-500 hover:text-slate-300 hover:bg-slate-800/50 transition-all cursor-not-allowed">
                                <i data-lucide="mic" class="mr-3 h-5 w-5 opacity-50"></i> Mock Interview
                            </button>
                            <button @click="showToast('Auto-Fill Integration is coming soon!', 'info')" class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border border-transparent text-slate-500 hover:text-slate-300 hover:bg-slate-800/50 transition-all cursor-not-allowed">
                                <i data-lucide="form-input" class="mr-3 h-5 w-5 opacity-50"></i> Auto-Fill
                            </button>
                            <button @click="showToast('Advanced Analytics Dashboard is coming soon!', 'info')" class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border border-transparent text-slate-500 hover:text-slate-300 hover:bg-slate-800/50 transition-all cursor-not-allowed">
                                <i data-lucide="bar-chart-2" class="mr-3 h-5 w-5 opacity-50"></i> Analytics
                            </button>
                            <button @click="showToast('LinkedIn Integration is coming soon!', 'info')" class="w-full group flex items-center px-4 py-3 text-sm font-bold rounded-xl border border-transparent text-slate-500 hover:text-slate-300 hover:bg-slate-800/50 transition-all cursor-not-allowed">
