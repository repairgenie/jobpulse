...
- Name: tests/e2e/02_cover_letter_resume.spec.js >> Cover Letter & Resume Generation (Issue #54) >> resume upload and management UI loads
- Location: tests/e2e/02_cover_letter_resume.spec.js:30:3
