...
- Name: tests/e2e/02_cover_letter_resume.spec.js >> Cover Letter & Resume Generation (Issue #54) >> generalize_resume API endpoint responds
- Location: tests/e2e/02_cover_letter_resume.spec.js:18:3
